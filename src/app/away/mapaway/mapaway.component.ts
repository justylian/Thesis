...
export class MapawayComponent implements OnInit {
  ...
  public getRemainingdays(remainingDays) {
    ...
    var arrivaldate =
      monthno +
      "/" +
      this.upcoming.flight.arrival.arrivaldate +
      "/" +
      this.upcoming.flight.arrival.arrivalyear;
  ...
  public mapMinify() {
    ...
    setTimeout(function() {
      $("#away .stage").animate(
        { width: 180, height: 170, borderRadius: "50%" },
        800
      );
    ...
    setTimeout(function() {
      $("#away .ball-in").css(
        "animation",
        "move-map-globe 60s infinite linear"
      );
    }, 800);
  }
  ...
  public mapMaximize() {
    ...
    $("#away .stage").animate(
      { width: 1395, height: 750, borderRadius: "0%" },
      1000
    );
